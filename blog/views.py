...
def contacts(request):
    ...
    return render(request, 'contacts.html',
                  context={'posts': posts, 'tags': tags, 'categories': categories, 'form': form})
...
def post_detail(request, slug):
    ...
    return render(request, 'post_detail.html',
                  context={'post': post, 'tags': tags, 'categories': categories, 'comments': comments,
                           'c_form': c_form})
...
def category_detail(request, slug):
    ...
    return render(request, 'category_detail.html',
                  context={'category': category, 'tags': tags, 'categories': categories})
